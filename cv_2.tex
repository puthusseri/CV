...
\section{SKILLS}
    ...
    \\
    \textbf{Tools/Framework : } Unity3D, Etherum, Flask
    \\
    \textbf{Familiar : } Java, Angular

\section{PROJECTS} 

    \sl

    \normalfont \textbullet{ \textbf{  Automatic Multiple Choice Questions Generator }} \hfill [2020] \\ 
     English reading comprehension MCQs are generated using the deeplearning techniques for NLP tasks.
\\
    \normalfont \textbullet{ \textbf{  Solution for Customer Loyalty problem using Blockchain }} \hfill [2020] \\ 
     Had used etherum blockchain network to create the smart contract.
\\
    \normalfont \textbullet{ \textbf{  Face Generation }} \hfill [2019] \\ 
...
\\
    \normalfont \textbullet{ \textbf{  Generate TV Scripts }} \hfill [2019] \\ 
...
\\
    ...
    \normalfont \textbullet{ \textbf{ VR Tour for Kerala Tourism }} \hfill [2019]\\ 
     ...
     \\     \normalfont \textbullet{ \textbf{  Animal Fight }} \hfill [2018] \\ 
...
\section{COURSE}
    \sl \normalfont{
        \textbullet{}Deep Learning Nanodegree from Udacity \hfill [2020] \\ 
        \textbullet{}Capstone: Retrieving, Processing, and Visualizing Data with Python by University of Michigan (Coursera)  \hfill [2020] \\ 
        \textbullet{}Using Python to Access Web Data by University of Michigan (Coursera)  \hfill [2020] \\ 
        \textbullet{}Using Databases with Python by University of Michigan (Coursera)  \hfill [2020] \\ 
        \textbullet{}Python Data Structures by University of Michigan (Coursera)  \hfill [2020] \\ 
        \textbullet{}Programming for Everybody Getting Started with Python  by University of Michigan (Coursera)  \hfill [2020] \\ 
